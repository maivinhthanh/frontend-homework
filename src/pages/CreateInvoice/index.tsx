...
import invoiceSchema from './invoiceSchema'; // Adjust the import path as needed
...
const CreateInvoice = () => {
  ...
  return (
    <Formik initialValues={initialValues} validationSchema={invoiceSchema} innerRef={formikRef} onSubmit={handleSubmit}>
      {({ values, touched, errors, handleChange, handleBlur, setFieldValue, handleSubmit }) => {
        ...
        const total = useMemo(() => {
          return values.products.reduce((sum, curr) => {
            ...
            <Stack spacing={2} direction="column">
              ...
              >
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={4}>
                    <FormControl variant="filled" fullWidth error={touched.type && !!errors.type}>
                  ...
                  <Grid item xs={4}>
                    <FormControl variant="filled" fullWidth error={touched.contractor && !!errors.contractor}>
                  ...
                  <Grid item xs={4}>
                    <FormControl variant="filled" fullWidth error={touched.vat && !!errors.vat}>
                  ...
                  <Grid item xs={4}>
                    <FormControl variant="filled" fullWidth error={touched.bankAccount && !!errors.bankAccount}>
                  ...
                  <Grid item xs={4}>
                    <FormControl variant="filled" fullWidth error={touched.payment && !!errors.payment}>
